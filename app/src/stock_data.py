...
if __name__ == "__main__":   
    try:
        ...
        goo_emad_5_50 = GooEmaDelta(ema_short=5, ema_long=50, period=5).calculate(data_df)
        ...
        chart.add_sub_plot(goo_emad_5_50, name="GooEmaDelta 5-50", pane_index=1, plot_attribute=goo_emad_attr, color_map=goo_emad_colormap)
